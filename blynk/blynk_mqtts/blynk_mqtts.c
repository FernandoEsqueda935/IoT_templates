...
extern const uint8_t blynk_pem_start[] asm("_binary_blynk_pem_start");
extern const uint8_t blynk_pem_end[] asm("_binary_blynk_pem_end");
...
void mqtt_init ( void ) {
    ...
    esp_mqtt_client_config_t cfg = {
        .broker.address.uri = "mqtts://blynk.cloud",
        ...
        .broker.verification.certificate = (const char *)blynk_pem_start,
    };
